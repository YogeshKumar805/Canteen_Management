    ...
    previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-red">Tit</span> <span class="clr-green">Canteen</span></h1></a>
                </div>
                <!-- Toggle Bars -->
...
if (signUpModal){
    ...
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="md">Welcome to <br><span class="clr-red md">Tit</span> <span class="clr-green md">Canteen</span></div>
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        ...
                        <p>Technocrats institute of Techonology is governed by Indus 
                        Global Educational & Welfare Society which was founded 
                        in 1999 by a group of industrialists and educationalists
                        who shared a vision of establishing centers of scientific
                        learning around the country.</p>
                        <ul class="py-1">
                            <li><i class="fab fa-facebook-f"></i><a href="https://www.facebook.com/technocratsinstituteof technology/" target="_blank"> Facebook</a></li>
                            <li><i class="fab fa-instagram"></i><a href="https://www.instagram.com/technocratstitgroup?igsh=MWppaXRpM2NxbzE3eQ==" target="_blank">Instagram</a></li>
                        </ul>
                    </article>
                    <!-- Navigation Links -->
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="our-vision.html">Our Vision</a></li>
                            <li><a href="https://github.com/rvutd/tit-canteen-site" target="_blank">Git Repository</a></li>
                            <li><a href="https://titbhopal.co.in/" target="_blank">TIT,Bhopal</a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-envelope"></i> <p>admission@titbhopal.co.in</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>Anand nagar,Bhopal</p></li>
                            <li> <i class="fas fa-globe-asia"></i> <p>For Professional Courses, Visit: www.titfees.ac.in</p></li>
                        </ul>
                    </article>
                </main>
                <!-- Yogi's Team Info -->
                <main class="Yogesh Kumar">
                    <div>© Copyright 2024 - 2025. All Rights Reserved</div>
                    <div class="">Designed & Developed with <i class="fas fa-heart clr-red"></i> By <a href="#">Yogesh Kumar</a></div>
                </main>
            </section>
        `;
        })
        ...
        userFooter.forEach(element => {
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        <h1 class="sm">about</h1>
                        <p>Technocrats Institute of Technology is governed by Indus 
                        Global Educational & Welfare Society which was founded 
                        in 1999 by a group of industrialists and educationalists
                        who shared a vision of establishing centers of scientific
                        learning around the country.</p>
                        <ul class="py-1">
                            <li><i class="fab fa-facebook-f"></i><a href="https://www.facebook.com/Technocratsinstituteof technology,Bhopal/" target="_blank"> Facebook</a></li>
                            <li><i class="fab fa-instagram"></i><a href="https://www.instagram.com/technocratstitgroup?igsh=MWppaXRpM2NxbzE3eQ==" target="_blank">Instagram</a></li>
                        </ul>
                    </article>
                    <!-- Navigation Links -->
